...
func (d *Daemon) UpdateProxyRedirect(e logger.EndpointUpdater, l4 *policy.L4Filter, proxyWaitGroup *completion.WaitGroup) (uint16, error, revert.FinalizeFunc, revert.RevertFunc) {
	if d.l7Proxy == nil {
...
// endpoint
func (d *Daemon) RemoveProxyRedirect(e logger.EndpointInfoSource, id string, proxyWaitGroup *completion.WaitGroup) (error, revert.FinalizeFunc, revert.RevertFunc) {
	if d.l7Proxy == nil {
		return nil, nil, nil
	}
...
func (d *Daemon) UpdateNetworkPolicy(e logger.EndpointUpdater, policy *policy.L4Policy,
...
// L7 proxies.
func (d *Daemon) RemoveNetworkPolicy(e logger.EndpointInfoSource) {
	if d.l7Proxy == nil {
		return
	}
